...
/**
 * Created by zhanggang02 on 2016/8/8.
 */
public class MethodHandleTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        getMethodHandler(obj, "println").invokeExact("icyfenix");
    }

    private static MethodHandle getMethodHandler
            (Object reveiver, String methodName) throws Throwable {
        ...
        return lookup().findVirtual(reveiver.getClass(), methodName, mt).bindTo(reveiver);
    }
}
